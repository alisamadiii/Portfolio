...
You can follow me on my new X page where I will share my works: [@alisamadi\_\_](https://x.com/alisamadi__); You can also check the source code [here](https://github.com/AliReza1083/Portfolio/tree/main/src/preview/framer-motion).