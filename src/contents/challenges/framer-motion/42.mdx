---
title: Day 42 - Mastering Framer Motion
---

# Day 42 - Mastering Framer Motion

<Tabs id="day-42">

<Tab label="Preview">

<ComponentPreview name="framer-motion-day-42" />

</Tab>

<Tab label="Code">

```tsx title="components/day-42.tsx" showLineNumbers
"use client";
