---
title: Day 45 - Mastering Framer Motion
---

# Day 45 - Mastering Framer Motion

<Tabs id="day-45">

<Tab label="Preview">

<ComponentPreview name="framer-motion-day-45" />

</Tab>

<Tab label="Code">

```tsx title="components/day-45.tsx" showLineNumbers
"use client";
