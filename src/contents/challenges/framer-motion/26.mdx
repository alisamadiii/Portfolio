---
title: Day 26 - Mastering Framer Motion
---

# Day 26 - Mastering Framer Motion

<Tabs id="day-26">

<Tab label="Preview">

<ComponentPreview name="framer-motion-day-26" />

</Tab>

<Tab label="Code">

```tsx title="components/day-26.tsx" showLineNumbers
"use client";
