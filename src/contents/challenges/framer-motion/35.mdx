---
title: Day 35 - Mastering Framer Motion
---

# Day 35 - Mastering Framer Motion

<Tabs id="day-35">

<Tab label="Preview">

<ComponentPreview name="framer-motion-day-35" />

</Tab>

<Tab label="Code">

```tsx title="components/day-35.tsx" showLineNumbers
"use client";
