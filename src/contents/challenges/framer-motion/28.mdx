---
title: Day 28 - Mastering Framer Motion
---

# Day 28 - Mastering Framer Motion

<Tabs id="day-28">

<Tab label="Preview">

<ComponentPreview name="framer-motion-day-28" className="bg-[#E7E9EC] h-[600px]" />

</Tab>

<Tab label="Code">

```tsx title="components/day-28.tsx" showLineNumbers
"use client";
