---
title: Day 21 - Mastering Framer Motion
---

# Day 21 - Mastering Framer Motion

<Tabs id="day-21">

<Tab label="Preview">

<ComponentPreview name="framer-motion-day-21" className="bg-[#0E0C0E] px-4" />

</Tab>

<Tab label="Code">

```tsx title="components/day-21.tsx" showLineNumbers
"use client";
