---
title: Day 20 - Mastering Framer Motion
---

# Day 20 - Mastering Framer Motion

<Tabs id="day-20">

<Tab label="Preview">

<ComponentPreview name="framer-motion-day-20" className="bg-[#0B0B0B]" />

</Tab>

<Tab label="Code">

```tsx title="components/day-20.tsx" showLineNumbers
"use client";
...
> **What I learnt**:
> - Nowadays I am using `mix blend mode` a lot.
>
> Inspired by [**Hristiyan Iv**](https://x.com/hristiyan_iv/status/1797732381383901209)
> 