---
title: Day 13 - Mastering Framer Motion
---

# Day 13 - Mastering Framer Motion

<Tabs id="day-13">

<Tab label="Preview">

<ComponentPreview name="framer-motion-day-13" />

</Tab>

<Tab label="Code">

```tsx title="components/day-13.tsx" showLineNumbers
"use client";
