---
title: Day 29 - Mastering Framer Motion
---

# Day 29 - Mastering Framer Motion

<Tabs id="day-29">

<Tab label="Preview">

<ComponentPreview name="framer-motion-day-29" className="bg-[#080808]" />

</Tab>

<Tab label="Code">

```tsx title="components/day-29.tsx" showLineNumbers
"use client";
