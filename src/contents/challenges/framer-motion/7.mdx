---
title: Day 7 - Mastering Framer Motion
---

# Day 7 - Mastering Framer Motion

<Tabs id="day-7">

<Tab label="Preview">

<ComponentPreview name="framer-motion-day-7" />

</Tab>

<Tab label="Code">

```tsx title="components/day-7.tsx" showLineNumbers
"use client";
...
> This design needs to be in full width and height, that is why it is not looking great.