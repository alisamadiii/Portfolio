---
title: Day 50 - Mastering Framer Motion
---

# Day 50 - Mastering Framer Motion

<Tabs id="day-50">

<Tab label="Preview">

<ComponentPreview name="framer-motion-day-50" />

</Tab>

<Tab label="Code">

```tsx title="components/day-50.tsx" showLineNumbers
"use client";
