---
title: Day 8 - Mastering Framer Motion
---

# Day 8 - Mastering Framer Motion

<Tabs id="day-8">

<Tab label="Preview">

<ComponentPreview name="framer-motion-day-8" />

</Tab>

<Tab label="Code">

```tsx title="components/day-8.tsx" showLineNumbers
"use client";
