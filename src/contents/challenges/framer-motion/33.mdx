---
title: Day 33 - Mastering Framer Motion
---

# Day 33 - Mastering Framer Motion

<Tabs id="day-33">

<Tab label="Preview">

<ComponentPreview name="framer-motion-day-33" />

</Tab>

<Tab label="Code">

```tsx title="components/day-33.tsx" showLineNumbers
"use client";
