---
title: Day 15 - Mastering Framer Motion
---

# Day 15 - Mastering Framer Motion

<Tabs id="day-15">

<Tab label="Preview">

<ComponentPreview name="framer-motion-day-15" />

</Tab>

<Tab label="Code">

```tsx title="components/day-15.tsx" showLineNumbers
"use client";
