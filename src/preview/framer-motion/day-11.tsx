...
export default function Day11() {
  ...
  // Create a transform to dynamically calculate border radius based on y
  const borderRadius = useTransform(ySmooth, [0, 200], [0, 48]);
  // const opacity = useTransform(ySmooth, [0, 300], isOpen ? [0.7, 0] : [0, 0]);
  const scale = useTransform(ySmooth, [0, 200], isOpen ? [0.8, 1] : [1, 1]);

  return (
    <div className="flex h-dvh w-full items-center justify-center bg-gradient-to-tr from-black to-black/90">
      <IphoneSimulator>
        <MotionConfig transition={{ duration: 0.5, type: "spring", bounce: 0 }}>
          <motion.div layout style={{ scale }} className="px-4">
            ...
            <p className="mt-2 text-xs text-white/50">
              ...
              Expedita, enim blanditiis, illum deleniti architecto alias at
              reprehenderit tenetur voluptate soluta dolor nostrum harum
              mollitia aperiam ipsam. Quasi iusto consequuntur unde!
            </p>
            <h2 className="mb-3 mt-3">Lorem Ipsum</h2>
          ...
          <AnimatePresence>
            {isOpen && (
              ...
              >
                ...
                >
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                  Officiis nisi impedit molestiae aspernatur ut repellendus
                  eaque quam qui tempore placeat voluptatibus similique quaerat,
                  velit deserunt sint dolore blanditiis ducimus nulla.
                </motion.p>
              </motion.div>
            )}
          </AnimatePresence>
