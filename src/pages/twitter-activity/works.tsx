...
export default function Twitter_Activity({}: Props) {
  ...
  return (
    <>
      <Meta_Tag
        title="Animated Contents"
        description="We provide you the best content to learn something very easily. The visual descriptions of development principles that We creates are very clear."
      />
