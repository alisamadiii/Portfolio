  ...
  return (
    <div className="mt-6 space-y-8">
      <p className="font-bold leading-7">
        Hi everyone, I&apos;d like to showcase some of my recent projects. These
        are projects that I&apos;ve been working on and I&apos;m excited to
        share them with you. Each project demonstrates my skills in Front-End &
        Back-End. I&apos;ve put a lot of effort into each project, and I hope
        you find them interesting and informative.
      </p>
      <a
