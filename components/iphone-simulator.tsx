...
export default function IphoneSimulator({ children }: Props) {
  return (
    <div className="aspect-[4/8] w-full max-w-[393px] rounded-[64px] border border-[#424242] bg-[#131313] p-2">
      <div className="relative isolate flex h-full w-full flex-col overflow-hidden rounded-[58px] bg-[#181818]">
        <header className="grid grid-cols-4 items-center px-[45px] py-[10px]">
          <h3 className="text-sm">9:41</h3>
          <div className="col-span-2 mx-auto h-[31px] w-[108px] rounded-full bg-black"></div>
        ...
        <footer className="flex justify-center py-[10px]">
          <div className="h-1 w-full max-w-[119px] rounded-full bg-white"></div>
        </footer>
      </div>
    </div>
  );
