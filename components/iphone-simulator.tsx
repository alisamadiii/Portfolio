...
export default function IphoneSimulator({
  ...
  return (
    <div
      className={cn(
        "relative aspect-[4/8] w-[367px] rounded-[56px] border-[1.5px] border-[#7E7D7E] bg-[#2C2C2B] p-1 text-[var(--ios-simulator-color)]"
      )}
      // @ts-ignore
    ...
    >
      ...
      <MotionConfig transition={transition || { duration: 0.3 }}>
        <div className={cn("h-full w-full rounded-[52px] bg-black p-[4px]")}>
          <div className="relative isolate flex h-full w-full flex-col overflow-hidden rounded-[46px]">
            <header className="grid grid-cols-4 items-center px-[40px] py-[10px]">
              <div>
                <motion.h3
                  initial={{
