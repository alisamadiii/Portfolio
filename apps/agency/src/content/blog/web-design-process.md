...
![A creative brainstorming session with sticky notes on a wall](/blog/discovery.webp)
...
![Wireframe sketches and planning notes on paper](/blog/strategy.webp)
...
![Lines of code on a laptop screen](/blog/execution.webp)
...
![A person happily using a laptop to update their website](/blog/launch.webp)
...
**What's the first step in web design?**
Discovery — figuring out what the site needs to do and who it's for, ideally written down as a brief. It's not the fun step, but it's the one that makes every other step cheaper. Start with a colour palette instead and you'll redo the whole thing.
