          ...
          <div className="flex gap-3">
            {SOCIAL_ICONS.map((Icon, i) => (
              <a
                key={i}
                href="#"
                className="border-border text-muted-foreground hover:text-primary hover:border-accent/30 flex h-9 w-9 items-center justify-center border transition-all duration-300"
              >
        ...
        <GridCell>
          ...
          <div className="flex">
            <input
              ...
              className="border-border focus:border-accent/50 placeholder:text-muted-foreground/50 flex-1 border bg-transparent px-4 py-2.5 text-sm transition-colors outline-none"
            />
            <button className="border-border hover:bg-accent hover:border-accent hover:text-primary-foreground flex h-11 w-11 items-center justify-center border border-l-0 transition-all duration-300">
