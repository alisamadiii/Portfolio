...
import { CMD, HERO_VIDEO, MONO, noop, TRUST } from "../lib/constants";
...
export function Hero() {
  ...
  return (
    <header
      id="top"
      style={{ position: "relative", padding: "clamp(120px, 16vh, 168px) 0 0" }}
    >
      <div
        style={{
          position: "absolute",
      ...
      >
        <div data-reveal style={{ flex: 1.1, minWidth: "min(100%, 420px)" }}>
          ...
          >
            Production-ready full-stack and monorepo templates with auth,
            payments, billing, and a database already wired together. Clone it,
            configure it, deploy.
          </p>
          <div
            style={{
            ...
            >
              ...
              {termDone && (
                <div data-reveal data-on="1" style={{ whiteSpace: "nowrap" }}>
                  ...
                  <div>
                    <span style={{ color: "#4ADE80" }}>✓</span> Installing
                    dependencies
                    <span style={{ color: "#52525B" }}> ··········· </span>done
                  </div>
                  <div>
                    <span style={{ color: "#4ADE80" }}>✓</span> Generating
                    Drizzle schema
                    <span style={{ color: "#52525B" }}> ········· </span>done
                  </div>
                  <div>
                    <span style={{ color: "#4ADE80" }}>✓</span> Wiring Better
                    Auth + Polar
                    <span style={{ color: "#52525B" }}> ········ </span>done
                  </div>
                  <div style={{ height: 14 }} />
