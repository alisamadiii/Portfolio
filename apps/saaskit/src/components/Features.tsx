...
function BentoMeta({
  ...
  return (
    <div>
      ...
      <p
        style={{ margin: 0, color: "#71717A", fontSize: 14.5, lineHeight: 1.6 }}
      >
        {body}
      </p>
    </div>
    ...
    >
      <div style={container()}>
        ...
        >
          ...
          >
            Every integration below ships configured, typed, and tested — so the
            first line of code you write is your product.
          </p>
        </div>

        <div
          data-reveal
          style={{ display: "grid", gridTemplateColumns: cols, gap: 16 }}
        >
          {/* 01 AUTH — span 2 */}
          ...
          <div className="bento-card" style={bentoCardStyle(span2)}>
            ...
            >
              ...
              >
                subscription.active → users.plan ={" "}
                <span style={{ color: "#A1A1AA" }}>"pro"</span>
              </div>
            </div>
            <BentoMeta
              label="02 — PAYMENTS"
          ...
          <div className="bento-card" style={bentoCardStyle()}>
            ...
            >
              ...
              <div style={{ whiteSpace: "nowrap" }}>
                <span style={{ color: "#FAFAFA" }}>const</span> users = pgTable(
                <span style={{ color: "#D4D4D8" }}>"users"</span>)
              </div>
              <div style={{ whiteSpace: "nowrap" }}>
                <span style={{ color: "#FAFAFA" }}>const</span> sessions =
                pgTable(<span style={{ color: "#D4D4D8" }}>"sessions"</span>)
              </div>
              <div style={{ whiteSpace: "nowrap" }}>
                <span style={{ color: "#FAFAFA" }}>const</span> subs = pgTable(
                <span style={{ color: "#D4D4D8" }}>"subs"</span>)
                <span
                  style={{
              ...
              <div
                style={{ marginTop: 6, color: "#52525B", whiteSpace: "nowrap" }}
              >
                → pushed to Neon{" "}
                <span style={{ color: "#A1A1AA" }}>in 0.8s</span>
              </div>
            </div>
            <BentoMeta
              label="03 — DATABASE"
          ...
          <div className="bento-card" style={bentoCardStyle()}>
            ...
            >
              ...
              <div style={{ whiteSpace: "nowrap" }}>
                <span style={{ color: "#FAFAFA" }}>const</span> {"{ data }"} =
                useQuery(
              </div>
          ...
          <div className="bento-card" style={bentoCardStyle(span2)}>
            ...
            >
              ...
              >
                ...
                />
                <span
                  style={{ height: 5, background: "#D4D4D8", borderRadius: 2 }}
                />
                <span
                  style={{ height: 5, background: "#E4E4E7", borderRadius: 2 }}
                />
                <span
                  style={{ height: 5, background: "#E4E4E7", borderRadius: 2 }}
                />
              ...
              >
                {[
                  ...
                  [
                    ...
                    <span
                      key="r"
                      style={{ color: "#0A0A0A", whiteSpace: "nowrap" }}
                    >
                      Jul 12
                    </span>,
                    false,
          ...
          <div className="bento-card" style={bentoCardStyle(span2)}>
            ...
            >
              <div style={{ whiteSpace: "nowrap" }}>
                ...
                <span style={{ color: "#FAFAFA" }}>saaskit deploy</span>
              </div>
              <div
                style={{
                  height: 4,
              ...
              >
                <div
                  style={{
                    ...
                    background: "#FAFAFA",
                    borderRadius: 2,
                    animation: "kfFill 3.6s ease-in-out infinite",
                  }}
                />
              </div>
              <div
                ...
                <span style={{ color: "#A1A1AA", whiteSpace: "nowrap" }}>
                  <span
                    style={{
                      ...
                      background: "#FAFAFA",
                      marginRight: 8,
                      animation: "kfPulse 2.4s ease-in-out infinite",
                    }}
                  />
                  live — saaskit.app
                </span>
