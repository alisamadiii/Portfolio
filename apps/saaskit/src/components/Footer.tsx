...
type FooterLink = { href: string; label: string; route?: boolean; external?: boolean }
      ...
      <div style={container()}>
        ...
        <div style={{ borderTop: '1px solid #18181B', paddingTop: 28, display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: 16 }}>
          ...
          <div style={{ display: 'flex', gap: 24 }}>
            <a href="https://x.com" target="_blank" rel="noreferrer" className="foot-lnk" style={{ fontFamily: MONO, fontSize: 12, color: '#71717A', textDecoration: 'none', whiteSpace: 'nowrap', transition: 'color 0.2s' }}>X ↗</a>
            <a href="https://github.com" target="_blank" rel="noreferrer" className="foot-lnk" style={{ fontFamily: MONO, fontSize: 12, color: '#71717A', textDecoration: 'none', whiteSpace: 'nowrap', transition: 'color 0.2s' }}>GitHub ↗</a>
          </div>
        </div>
      </div>
    </footer>
