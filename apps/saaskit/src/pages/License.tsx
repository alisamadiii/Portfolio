  ...
  return (
    <PageLayout>
      ...
      <Section title="Summary">
        <P>
          When you purchase SaaSKit you get a perpetual, non-exclusive license
          to use the source code to build and ship your own products. The
          Full-Stack and Monorepo licenses are per developer; the Bundle / Team
      ...
      <Section title="Per-developer & team seats">
        <P>
          A single license is tied to one developer. If your team needs access
          for several people, the Bundle / Team license grants up to 10 seats
          within one company. Need more seats? Reach out and we'll sort it.
        </P>
      </Section>

      <Section title="Updates & access">
        <P>
          Every purchase includes lifetime access to the private repo. When the
          stack moves — a Next.js major, a Better Auth release, a Polar API
          change — the template is updated and you pull the changes. Access is
      ...
      <Section title="Refunds">
        <P>
          Because you receive the full source immediately, purchases are
          generally non-refundable. If something is genuinely broken and we
          can't make it right, email us within 14 days and we'll make it fair.
        </P>
      </Section>
