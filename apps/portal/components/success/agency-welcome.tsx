...
const NEXT_STEPS = [
  ...
  },
  {
    ...
    body: "Track progress, invoices, and requests from your portal dashboard while your site takes shape.",
  },
  {
        ...
        {!isLoggedIn && (
          <div className="bg-card mt-6 overflow-hidden rounded-lg border">
            <div className="space-y-2 px-5.5 py-5">
              ...
              <p className="text-muted-foreground text-sm">
                Your client portal is where you track the project, invoices,
                and requests.
                {data.customerEmail ? (
                  <>
                    {" "}
            ...
            <div className="card-band">
              <Button
                ...
                render={<Link href="/login?redirectUrl=%2Fagency" />}
              >
                Sign in
              </Button>
              <Button
                ...
                render={
                  <Link
                    href={`/signup?redirectUrl=%2Fagency${
                      data.customerEmail
      ...
      <Section delay={0.4}>
        <div className="mt-10 grid grid-cols-1 gap-3 sm:grid-cols-2">
          {links.map((link) => {
            ...
            const className =
              "bg-card group block rounded-lg border px-5.5 py-4.5 transition-colors hover:border-foreground/20";
