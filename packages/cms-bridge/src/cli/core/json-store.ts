...
/**
 * Set a value at a path, overwriting any existing leaf (creates intermediate
 * objects). Returns false only when a non-object blocks the path. Used by
 * auto-mode dev sync where the last edit deliberately wins.
 */
