/**
 * Atomic multi-file commit via the Git Data API, shared by the legacy publish
 * router and the v2 publish path. One tree, one commit, non-forced ref update;
...
import { updateFileCache } from "./github-cache-file";
