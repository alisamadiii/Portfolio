...
function PopoverTitle({ className, ...props }: React.ComponentProps<"h2">) {
  return (
    <div
      ...
      className={cn("text-lg leading-[120%] font-bold", className)}
      {...props}
    />
  );
}
