...
function SidebarMenuButton({
  ...
  // Radix `asChild` compat: render as the single child element (Base UI keeps
  // the element's own children, so don't re-inject them).
  let resolvedRender = render;
  let resolvedChildren: React.ReactNode = children;
  if (asChild && !render && React.isValidElement(children)) {
    resolvedRender = children as useRender.ComponentProps<"button">["render"];
  ...
  return (
    <Tooltip>
      <TooltipTrigger render={<button />}>{buttonElement}</TooltipTrigger>
      <TooltipContent
        side="right"
        align="center"
...
function SidebarMenuSubButton({
  ...
  let resolvedChildren: React.ReactNode = children;
  if (asChild && !render && React.isValidElement(children)) {
    resolvedRender = children as useRender.ComponentProps<"a">["render"];
    resolvedChildren = undefined;
  }
