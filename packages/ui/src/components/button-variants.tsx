...
// Kept in a non-"use client" module so Server Components can call
// buttonVariants() (e.g. to style a <Link>) without pulling in the client
// Button. button.tsx re-exports this for backwards compatibility.
