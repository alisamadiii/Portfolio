...
export default function Day17() {
  ...
  return (
    <>
      <WhatILearnt
        values={[
          `We have the texts "GAME WE LOVE" and "World of Warships: Legends". I was using <b>padding</b> to it's parent element for giving them space as we have now. However, when the layout animation was happening, I got a weird shared layout animation with the texts, it was not working as expected. when I changed to using <b>translate</b>, it worked.`,
          `I learnt to not use <b>overflow hidden</b> when it is not necessary to do so, because we might get a strange behavior. <i>(It took me a while to find where the problem is coming from)</i>`,
                  ...
                  >
                    ...
                    >
                      <p className="text-lg leading-6 text-[#959597]">
                        ...
                        <b className="text-black">cupiditate</b> libero aliquid
                        ea fuga iure aut minima possimus! Deleniti veritatis
                        dicta eligendi veniam quaerat saepe doloribus itaque
                        debitis.
                      </p>
