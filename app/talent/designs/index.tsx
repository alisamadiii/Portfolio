...
export const NewIndex: IndexData = {
  ...
  "clip-path": [
    {
      name: "clip-path",
      component: React.lazy(() => import("./clip-path/clip-path")),
    },
    {
      name: "stripe-select-button",
      component: React.lazy(() => import("./clip-path/stripe-select-button")),
    },
  ],
  "50-day-challenge": [
    {
    ...
    {
      name: "day-46",
      component: React.lazy(() => import("./50-day-challenge/day-46")),
    },
    {
      name: "day-47",
      component: React.lazy(() => import("./50-day-challenge/day-47/index")),
    },
    {
      name: "day-48",
      component: React.lazy(() => import("./50-day-challenge/day-48/index")),
    },
    {
      name: "day-49",
      component: React.lazy(() => import("./50-day-challenge/day-49")),
    },
    {
      name: "day-50",
    ...
    },
    {
      ...
      component: React.lazy(
        () => import("./50-day-challenge/helping-others/index")
      ),
    },
  ],
  "30-day-challenge": [
